...
function Footer() {
    ...
    return (
        <div className='bg-textWhite mobile:pt-[2rem] tablet:pt-[6rem] pb-[1.5rem] mobile:px-[1rem] tablet:px-[5rem] dark:bg-lightBlack'>
            ...
            <div className='tablet:flex justify-between mt-[2rem] border-b border-lightBlack dark:border-textWhite mobile:pb-[3rem] tablet:pb-[9rem]'>

                <div className='mt-[12px] tablet:mt-[0px]'>
                ...
                <div className='flex tablet:flex-col mobile:gap-10 mobile:mt-[12px] tablet:mt-[0px] tablet:gap-4'>
