...
const SearchBar = (props: SearchProps) => {
  ...
  return (
    <div className=' py-4 flex w-[80%]  justify-around  border border-primaryGrey rounded-[10px] bg-textWhite dark:bg-lightBlack'>

      <div className='w-[18%] border-r px-2 border-primaryGrey  font-[800] flex items-center gap-2 '>
